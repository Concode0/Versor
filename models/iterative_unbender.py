...
from models.rotor_translate import RotorTranslator, RotorTerm, _log_corr_divide
...
class IterativeUnbender:
    ...
    def _prepare_data(self, X_orig, y_orig, X_norm, y_norm, var_names):
        ...
        if self.grouping_enabled:
            from models.variable_grouper import VariableGrouper
    ...
    def _single_group_fallback(self, X_orig, y_orig, var_names, Vt):
        ...
        from models.variable_grouper import VariableGroup
    ...
    def _orthogonal_eliminate(self, data_mv, blade, algebra):
        ...
        Args:
            data_mv: torch.Tensor [..., dim] multivector data.
            blade: torch.Tensor [dim] dominant blade from rotor.
            algebra: CliffordAlgebra.

        Returns:
            (rejected_mv, OrthogonalEliminationResult)
        """
    ...
    def _refine_all_terms(self, all_terms, X_orig, y_orig, all_ops=None):
        ...
        if has_div:
            logger.info("  Mixed composition detected, skipping joint refinement")
            return all_terms, all_ops
    ...
    # =======================================================================
    # Shared Helpers (carried from v1)
    # =======================================================================
